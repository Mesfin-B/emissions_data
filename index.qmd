...
emissions_long_1990_2022 = emissions_long[emissions_long['year'].between(1990, 2022, inclusive='both')]

# Query for 5 countries (adjust these to any countries you like)
countries = ['China', 'Canada', 'Nigeria', 'Saudi Arabia', 'USA']
emissions_long_subset = emissions_long_1990_2022[emissions_long_1990_2022["country"].isin(countries)]

# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(
    emissions_long_subset.sort_values(["country", "year"]), 
    x="year", 
    y="emissions", 
    color="country",
    title="Emissions (1990-2022)"
)
